"""Config flow to configure Xiaomi Smart Humidifier/Dehumidifier component."""
import logging
...
class XiaomiHumidifierFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a Xiaomi Smart Humidifier/Dehumidifier config flow."""
